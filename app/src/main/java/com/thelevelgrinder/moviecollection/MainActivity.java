 ...
 * Final Project
 * CSC 210
 * User can add movies and keep track of them in this app which is sorted by number and and alphabet.
 * 12/15/16
 */
...
public class MainActivity extends AppCompatActivity
    ...
    // key for storing a movies's Uri in a Bundle passed to a fragment
    ...
    public void onMovieDeleted() {
        // removes top of back stack
        getSupportFragmentManager().popBackStack();
        moviesFragment.updateMoviesList(); // refresh movies
    }
